 ...
 * @author PC
 */
public class JFrame_GiaoDienChinh extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_GiaoDienChinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	JFrame_GiaoDienChinh gd = new JFrame_GiaoDienChinh();
                gd.setVisible(true);
                gd.setLocationRelativeTo(null);
                gd.setResizable(false);
                gd.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                gd.setSize(Toolkit.getDefaultToolkit().getScreenSize());
